...
\node[right=0.05cm] at (current page.155){
    \includegraphics[width=1.35cm]{figures/NPSMN.jpg}
};
\end{tikzpicture}
}
...
\titlegraphic{\includegraphics[width=0.2\textwidth]{figures/Logo_Bad_herrenalb.JPG}{     }\includegraphics[width=0.18\textwidth]{figures/NPSMN.png}}
\institute{Naturpark Schwarzwald Mitte/Nord}
