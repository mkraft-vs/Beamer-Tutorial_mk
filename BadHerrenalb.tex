...
\titlegraphic{\includegraphics[width=0.2\textwidth]{figures/logo2.png}}
...
\begin{frame}{Gruppen-Einteilung}
	...
	\column{0.5\textwidth}
		\mbox{} \\
		\begin{overlayarea}{\textwidth}{0.4\textheight}
		\only<2->{\includegraphics[width=0.35\textwidth]{figures/Strasse.jpg}}
		\only<3->{\includegraphics[width=0.35\textwidth]{figures/Vorgarten.jpg}}
