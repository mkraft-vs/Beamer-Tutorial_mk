...
\node[right=0.08cm] at (current page.148){
    \includegraphics[width=1.2cm]{figures/Logo_Symbol_LVBI}
};
\end{tikzpicture}
}
...
\title[Bienenweide-240301]{\textbf{Lehrgang Bienenweide}}
\titlegraphic{\includegraphics[width=0.35\textwidth]{figures/BH-Logo.png}}
